...
import sys  # ✅ Needed for logging errors to stderr
...
async def make_nws_request(url: str) -> dict[str, Any] | None:
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            print(f"Request error: {e}", file=sys.stderr)  # ✅ Useful during debugging
            return None
...
if __name__ == "__main__":
    print("Weather MCP server is starting...", file=sys.stderr)  # ✅ Debug log
